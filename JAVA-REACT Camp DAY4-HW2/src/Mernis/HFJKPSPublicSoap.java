...
public class HFJKPSPublicSoap
{
    ...
    public HFJKPSPublicSoap(){}

    public HFJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HFJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HFJExtendedSoapSerializationEnvelope envelope= new HFJExtendedSoapSerializationEnvelope(HFJExtendedSoapSerializationEnvelope.VER11);
